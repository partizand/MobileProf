...
Процедура КомандаЗагрузитьИзФайлаНаСервере()
	...
	РаботаСФайлами.ЗагрузитьВопросыИзФайла(ПутьКФайлу, ОчиститьИсторию);
	
		
    РегистрыСведений.ХранилищеНастроек.ЗаписатьНастройку("ПутьКФайлуЗагрузки", ПутьКФайлу) ;
...
//	ОбщиеМакеты.Загрузка;//
	...
	РаботаСФайлами.ЗагрузитьВопросыИзМакета();
...
Процедура ПутьКФайлуНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ВыбранноеИмяФайла = ИнтерфейсныеФункции.ВыборФайла(РежимДиалогаВыбораФайла.Открытие);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	ПутьКФайлу = РегистрыСведений.ХранилищеНастроек.ПолучитьНастройку("ПутьКФайлуЗагрузки", "");
	Если ПустаяСтрока(ПутьКФайлу) Тогда
		ПутьКФайлу = РаботаСФайлами.АдресВопросовПоУмолчанию();	
	КонецЕсли
...
&НаСервереБезКонтекста
Функция КомандаУстановитьАдресПоУмолчаниюНаСервере()
	ПутьКФайлу =  РаботаСФайлами.АдресВопросовПоУмолчанию();
	РегистрыСведений.ХранилищеНастроек.ЗаписатьНастройку("ПутьКФайлуЗагрузки", ПутьКфайлу);
	Возврат ПутьКФайлу
КонецФункции
...
&НаКлиенте
Процедура КомандаУстановитьАдресПоУмолчанию(Команда)
	ПутьКФайлу = КомандаУстановитьАдресПоУмолчаниюНаСервере();
КонецПроцедуры
